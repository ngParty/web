      ...
      <style global jsx amp-custom="true">
        {`
          ...
          body {
            ...
            /* adding main-bacground to the top
    padding-top: 140px;
    */
          }
      ...
      */
          ...
          .header .tab.hamburger {
            ...
            align-self: center;
            background: url('/img/hamburger.svg') no-repeat center/30px 24px
              transparent;
            border: 0;
            cursor: pointer;
            display: none;
          ...
          amp-sidebar .close-button {
            background: url(./static/img/symbols/close.svg) no-repeat
              center/18px transparent;
            border: 0;
            height: 58px;
            position: absolute;
            right: 13px;
          ...
          amp-sidebar .return-button::before {
            background: url(./static/img/symbols/return.svg) no-repeat
          ...
          .ngparty-conf a.reserve-button:hover {
            text-decoration: none;
            background: #e69a00;
          }

          .ngparty-conf section.ngparty-conf-section {
            padding: 0;
          }

          .ngparty-conf section.ngparty-conf-section .wrapper {
            margin: 0 auto;
            width: 80%;
            max-width: 800px;
          }

          .ngparty-conf section.ngparty-conf-section h2 {
            font-size: 4em;
            margin-bottom: 0em;
          }

          .ngparty-conf section.ngparty-conf-section.teaser {
            margin-top: 80px;
            text-align: center;
          }

          .ngparty-conf section.ngparty-conf-section.teaser p {
            padding-bottom: 2em;
          }

          .ngparty-conf section.ngparty-conf-section.teaser p span {
            font-weight: 400;
          }

          .ngparty-conf section.ngparty-conf-section.description {
            background: #232323;
            margin-top: 40px;
            position: relative;
          }

          .ngparty-conf section.ngparty-conf-section.description p {
            background: #fff;
            padding: 1em;
            margin: 0 auto;
            width: 80%;
          ...
          .ngparty-conf section.ngparty-conf-section.description p span {
            display: block;
            text-align: left;
          }

          .ngparty-conf section.ngparty-conf-section.description ul {
            text-align: center;
            padding-bottom: 2em;
          }

          .ngparty-conf section.ngparty-conf-section.description ul li {
            background: #ffffff;
            padding: 6px 12px;
            padding-left: 20px;
            border-radius: 2px;
          ...
          .ngparty-conf section.ngparty-conf-section.description ul li::after {
            display: block;
            content: '';
            width: 4px;
            position: absolute;
          ...
          .ngparty-conf
            section.ngparty-conf-section.description
            ul
            li:first-child {
            margin-left: 0;
          }
          ...
          .ngparty-conf section.ngparty-conf-section.description ul a {
            color: #232323;
          }

          .ngparty-conf section.ngparty-conf-section.schedule {
            padding: 2em 0;
          }

          .ngparty-conf section.ngparty-conf-section.speakers {
            padding: 2em 0;
            background: #f5f5f5;
            padding-bottom: 4em;
          }

          .ngparty-conf section.ngparty-conf-section.workshops {
            padding: 2em 0;
            padding-bottom: 4em;
          }

          .ngparty-conf section.ngparty-conf-section.highlight {
            padding: 2em 0;
            background: #232323;
          }

          .ngparty-conf section.ngparty-conf-section.highlight .wrapper {
            display: -webkit-box;
            display: -ms-flexbox;
            display: flex;
            -ms-flex-wrap: wrap;
          ...
          .ngparty-conf
            section.ngparty-conf-section.highlight
            .wrapper
            amp-iframe {
            -webkit-box-flex: 1;
            -ms-flex: 1 0 40%;
          ...
          .ngparty-conf section.ngparty-conf-section.highlight .wrapper div {
            margin-left: 2em;
            -webkit-box-flex: 1;
            -ms-flex-positive: 1;
            flex-grow: 1;
          ...
          .ngparty-conf section.ngparty-conf-section.highlight h3 {
            color: #fff;
            margin-top: 0;
          }

          .ngparty-conf section.ngparty-conf-section.highlight p {
            color: #fff;
          }

          .ngparty-conf section.ngparty-conf-section.highlight a {
            color: #fff;
            text-decoration: underline;
          }

          .ngparty-conf section.ngparty-conf-section.highlight span {
            display: block;
          }

          .ngparty-conf section.ngparty-conf-section.faq {
            font-size: 16px;
            font-weight: normal;
          }

          .ngparty-conf section.ngparty-conf-section.faq h3 {
            color: #232323;
            font-size: 26px;
            font-weight: 300;
            margin-top: 1.1em;
          ...
          .ngparty-conf section.ngparty-conf-section.faq dd {
            margin-bottom: 1em;
            font-weight: 300;
          }

          .ngparty-conf section.ngparty-conf-section.footer ul {
            text-align: center;
          }

          .ngparty-conf section.ngparty-conf-section.footer ul li {
            display: inline-block;
            padding: 1em;
          }

          .ngparty-conf .code-of-conduct {
            padding-bottom: 2em;
            background: #fff;
            margin: 3%;
          }

          .ngparty-conf .code-of-conduct ul,
          .ngparty-conf .code-of-conduct ol {
            margin-left: 2em;
          }
          ...
          .ngparty-conf ul.schedule {
            list-style: none;
            margin-left: 114px;
          }

          .ngparty-conf ul.schedule > li {
            padding: 5px;
            padding-bottom: 10px;
            display: -webkit-box;
            display: -ms-flexbox;
          ...
          .ngparty-conf ul.schedule > li::after {
            content: '';
            display: block;
            position: absolute;
            width: 1px;
          ...
          .ngparty-conf ul.schedule > li div {
            padding-left: 23px;
          }

          .ngparty-conf ul.schedule > li span.image {
            display: block;
            border-radius: 50px;
            overflow: hidden;
            height: 100px;
          ...
          .ngparty-conf ul.schedule > li span.image.multiple {
            width: 60px;
            height: 60px;
          }

          .ngparty-conf ul.schedule > li span.image.multiple:nth-child(even) {
            left: -75px;
          }

          .ngparty-conf ul.schedule > li span.image.multiple:nth-child(2) {
            top: 10px;
          }

          .ngparty-conf ul.schedule > li span.image.multiple:nth-child(3) {
            top: 50px;
          }

          .ngparty-conf ul.schedule > li span.image.multiple:nth-child(4) {
            top: 90px;
          }

          .ngparty-conf ul.schedule > li span.image.multiple:nth-child(5) {
            top: 130px;
          }

          .ngparty-conf ul.schedule > li span.image.multiple:nth-child(6) {
            top: 170px;
          }

          .ngparty-conf ul.schedule > li h5 {
            font-size: 1em;
            margin: 0;
            color: inherit;
          }

          .ngparty-conf ul.schedule > li h5::before {
            display: none;
          }

          .ngparty-conf ul.schedule > li h5.session {
            font-weight: 500;
          }

          .ngparty-conf ul.schedule > li h5.keynote {
            font-weight: 500;
            color: #232323;
          }

          .ngparty-conf ul.schedule > li h5.panel,
          .ngparty-conf ul.schedule > li h5.workshop {
            font-weight: 500;
            color: #ff9800;
          }

          .ngparty-conf ul.schedule > li p {
            font-size: 13px;
            line-height: 1.6em;
          }

          .ngparty-conf ul.schedule time {
            position: relative;
            display: inline-block;
            font-family: monospace;
          }

          .ngparty-conf ul.schedule time::before {
            content: '';
            display: block;
            position: absolute;
            width: 12px;
          ...
          .ngparty-conf ul.schedule > li.session time::after,
          .ngparty-conf ul.schedule > li.keynote time::after {
            content: '';
            display: block;
            position: absolute;
            width: 12px;
          ...
          .ngparty-conf ul.schedule small {
            display: block;
            line-height: 1.6em;
          }

          .ngparty-conf ul.workshops {
            list-style: none;
            display: -webkit-box;
            display: -ms-flexbox;
            display: flex;
          ...
          .ngparty-conf ul.workshops li:nth-child(odd) {
            background: #f5f5f5;
          }

          .ngparty-conf ul.workshops li:last-child {
            border-right: 0;
          }

          .ngparty-conf ul.workshops li h6 {
            font-weight: normal;
            margin: 0;
            padding: 1em;
          }
          ...
          .ngparty-conf ul.speakers {
            list-style: none;
          }

          .ngparty-conf ul.speakers li {
            display: -webkit-box;
            display: -ms-flexbox;
            display: flex;
            min-height: 100px;
          ...
          .ngparty-conf ul.speakers li:nth-child(odd) {
            -webkit-box-orient: horizontal;
          ...
          .ngparty-conf ul.speakers li:nth-child(odd) .image {
            margin-right: 0;
            margin-left: 20px;
          }

          .ngparty-conf ul.speakers p {
            font-size: 13px;
            line-height: 1.6em;
          }

          .ngparty-conf ul.speakers .image {
            border-radius: 25vw;
            overflow: hidden;
            display: inline-block;
            height: 25vw;
...
const BigPartyIV = () => {
  return (
    <>
      <Head>
        <title>ngBigParty IV JavaScript REunited</title>
            ...
            <ul className="schedule">
              ...
              <li className="keynote">
                <span className="image multiple">
                  <amp-img
                    src="https://avatars3.githubusercontent.com/u/82104?v=3&u=6c7fe7d81e39a27d7312bb953f50913a9d740b14&s=400"
                    width="100"
                    height="100"
                  ></amp-img>
                </span>
                <span className="image multiple">
                  <amp-img
                    src="https://avatars1.githubusercontent.com/u/1223799?v=3&s=400"
                    width="100"
                    height="100"
                  ></amp-img>
                </span>
                <span className="image multiple">
                  <amp-img
                    src="https://avatars2.githubusercontent.com/u/4021908?v=3&s=400"
                    width="100"
                    height="100"
                  ></amp-img>
                </span>
              ...
              <li className="session">
                ...
                <div>
                  ...
                  <p>
                    Using the example of migrating an app from AngularJS to
                    Angular to illustrate themes we can identify when navigating
                    any major migration within a large software application.{' '}
                  </p>
                </div>
              </li>
              ...
              <li className="session">
                ...
                <div>
                  <h5 className="session">
                    How to build visual programming language for the API era
                    with #NodeJS{' '}
                  </h5>
                  <small>
                  ...
                  <small>
                    <a href="https://drive.google.com/open?id=0B2KT6SRe8z5pY1ZBM1g0Yl8zM1U">
                      slides
                    </a>
                  </small>
                </div>
              ...
              <li className="session">
                ...
                <div>
                  <h5 className="session">
                    Our journey migrating 100k lines of code from AngularJS to
                    React
                  </h5>
                  <small>
                    <a href="#sebastian">
                  ...
                  <p>
                    The JS environment is currently probably the fastest growing
                    development ecosystem. What do you do when new concepts pop
                    up within months? Can you still embrace new technologies?
                    How can you ensure minimal dependency on a framework? How
                    can you migrate without rewriting from scratch? At Small
                    Improvements we’ve build a huge AngularJS application and
                    are on our way to migrate to React/Redux. I want to share
                    our strategy, patterns and lessons learned from taking on
                    that journey.
                  </p>
                  <small>
                    <a href="https://docs.google.com/presentation/d/1Hd5xlAJrYKBlx8fX9h9kCL7bNdcgJOLLKpYccXq2THA/edit?usp=sharing">
                      Slides
                    </a>{' '}
                    |{' '}
                    <a href="https://github.com/sfroestl/angular-react-migration">
                      GITHUB REPOSITORY
                    </a>{' '}
                    |{' '}
                    <a href="https://tech.small-improvements.com/2017/01/25/how-to-migrate-an-angularjs-1-app-to-react/">
                      Blog
                    </a>
                  </small>
                </div>
              ...
              <li className="session">
                ...
                <time>1930</time>
                <div>
                  <h5 className="session">Why you should care about Elm</h5>
                  <small>
                    <a href="#tereza">Tereza Sokol, @noredink / DK</a>
                  </small>
                  <p>
                    Ensuring maintainability and reliability in large web
                    projects is notoriously challenging and this is partially
                    due to JavaScript’s language design. As an alternative to
                    Javascript, Elm is a typed, purely functional language
                    compiling to Javascript, designed to guide you towards
                    better applications while giving you the best possible
                    developer experience, by way of static analysis of your
                    code.
                  </p>
                  <small>
                    <a href="https://drive.google.com/open?id=0B2KT6SRe8z5pWXN0bUtaMTQ4SGM">
                      slides
                    </a>
                  </small>
                </div>
              ...
              <li className="session">
                ...
                <time>2000</time>
                <div>
                  <h5 className="session">A Vue over React</h5>
                  <small>
                    <a href="#andrei">Andrei Pfeiffer, @e_spres_oh / RO</a>
                  </small>
                  <p>
                    This talk is an overview on Vue's ecosystem, in comparison
                    to React.
                  </p>
                  <small>
                    <a href="https://drive.google.com/open?id=0B2KT6SRe8z5pQmVXc09aRm9UY28">
                      slides
                    </a>
                  </small>
                </div>
              ...
              <li className="session">
                ...
                <div>
                  ...
                  <p>
                    A talk about how we managed to harness and embrace the
                    React-Native technology. How we got an app from zero to
                    production, some of us without previous experience with
                    mobile development. In a corporate environment.
                  </p>
                  <small>
                    <a href="https://drive.google.com/open?id=0B8--qpC9KLjWcF9EMnJIUmZ2alk">
                      slides
                    </a>
                  </small>
                </div>
...
const Partners = (props: { data: typeof _data['partners'] }) => {
  const { data } = props
    ...
    <section className="speakers ngparty-conf-section">
      <div className="wrapper">
        ...
        <ul className="speakers">
          <li>
            <span className="image" data-name="Andrei Pfeiffer">
              <amp-img
                src="/img/speakers/andrei.png"
                width="400"
                height="400"
            ...
            <div>
              <h4 id="andrei">Andrei Pfeiffer, [e-spres-oh]</h4>
              <p>
                Code Designer @ [e-spres-oh], Mentor @ [e-spres-oh] Academy,
                Co-organizer @ tim.js
              </p>
            </div>
          </li>
          <li>
            <span className="image" data-name="Jaroslav Minařík">
              <amp-img
                src="/img/speakers/jaroslav.png"
                width="400"
                height="400"
            ...
            <div>
              <h4 id="jaroslav">Jaroslav Minařík, MSD</h4>
              <p>I like pizza!</p>
            </div>
          </li>
          <li>
            <span className="image" data-name="James Henry">
              <amp-img
                src="/img/speakers/james.jpg"
                width="400"
                height="400"
            ...
            <div>
              <h4 id="james">James Henry, UltimateAngular</h4>
              <p>
                Member of the ESLint Core Team, I am a TypeScript evangelist and
                long-term Angular user. I produce in-depth training coursers
                over on UltimateAngular.com
              </p>
            </div>
          </li>
          <li>
            <span className="image" data-name="Tereza Sokol">
              <amp-img
                src="/img/speakers/tereza.jpg"
                width="400"
                height="400"
            ...
            <div>
              <h4 id="tereza">Tereza Sokol, NoRedInk</h4>
              <p>
                I've been a frontend developer for about four years now and is
                currently working with Elm at NoRedInk!
              </p>
            </div>
          </li>
          <li>
            <span className="image" data-name="Sebastian Fröstl">
              <amp-img
                src="/img/speakers/sebastian.jpg"
                width="400"
                height="400"
            ...
            <div>
              <h4 id="sebastian">Sebastian Fröstl, Small Improvements</h4>
              <p>
                Team Lead. Software Engineer. Trainer. Coach. Devoted to
                Personal Development. Organizer of @angular_berlin.
              </p>
            </div>
          </li>
        </ul>
